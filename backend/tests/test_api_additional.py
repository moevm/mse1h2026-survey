...
def test_get_unknown_survey_returns_404(client):
    response = client.get("/public/survey/00000000-0000-0000-0000-000000000000")
...
def test_group_data_returns_disciplines_by_teacher(client, db_session):
    ...
    db_session.add_all([survey, group, teacher, first_discipline, second_discipline])
    db_session.flush()
    db_session.add_all([
    ...
    response = client.get(f"/group_data/ci-3341?survey_id={survey.id}")
